...
SECRET_KEY = 'django-insecure-^y-uw^$^#ykvoevu&^%uy%qpp=9un3d9dcs)26%0es%z0_w+i%'
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth',
    'django.contrib.contenttypes', # for contenttype framework
...
MIDDLEWARE = [
    ...
    "debug_toolbar.middleware.DebugToolbarMiddleware", # debug-tool-bar middleware
